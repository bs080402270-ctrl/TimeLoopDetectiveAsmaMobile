...
const ART_MENU := ART_MANHWA_MAIN
const ART_CASES := ART_MANHWA_MAIN
const ART_INTERROGATION := ART_MANHWA_MAIN
...
const ART_INTRO := ART_MANHWA_MAIN
const ART_DIFFICULTY := ART_MANHWA_MAIN
