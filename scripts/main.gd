...
const ART_INTERROGATION := "res://art/evidence_generated/interrogation_room.jpg"
const ART_CASEBOOK := "res://art/evidence_generated/evidence_room.jpg"
...
const ART_DIFFICULTY := "res://art/evidence_generated/evidence_room.jpg"
...
func _show_evidence_board() -> void:
	...
	for suspect_id in case_data.suspects.keys():
		...
		var contradiction_id: String = str(suspect.get("contradiction",{}).get("id",""))
		var broken: bool = contradiction_id != "" and contradiction_id in state.contradictions
		var marker: String = "✓" if interviewed else "○"
		var status: String = "CONTRADICTION EXPOSED" if broken else ("INTERVIEWED" if interviewed else "NOT INTERVIEWED")
